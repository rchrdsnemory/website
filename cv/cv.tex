...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {École Normale Supérieure (ENS-PSL), Institut Jean Nicod}{2022 - Present}
...
\section{Work Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Direction Interministérielle de la Transformation Publique (DITP)}{June 2020 -- August 2020}
...
\begin{enumerate}[label={[{\arabic*.}]}, left=0.15in, resume]
    \resumeItem{\textbf{Pfänder, J.\footnotemark[1]}, \& Altay, S. (2024). Spotting False News and Doubting True News: A Meta-Analysis of News Judgments. \url{https://doi.org/10.31219/osf.io/n9h4y} \emph{(Accepted)}
    }
