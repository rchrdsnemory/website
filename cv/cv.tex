...
\begin{enumerate}[label={[{\arabic*.}]}, left=0.15in, resume]
    \resumeItem{\textbf{Pfänder, J.\footnotemark[1]}, Kerzreho, L. & Mercier, H. (2024). Quasi-universal acceptance of basic science in the US. \url{https://osf.io/8utsj/} \emph{(Under review)}
    }
